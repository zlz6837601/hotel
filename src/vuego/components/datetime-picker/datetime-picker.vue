<template>
  <v-popup v-model="visible" position="bottom" @closeOnclickModal="closeOnClickModal" class="v-datetime">
    <v-picker
      :slots="dateSlots"
      @change="onChange"
      ...
      ref="picker"
      show-toolbar>
      <span class="v-datetime__action v-datetime__cancel" @click="visible = false;$emit('cancel')">{{ cancelText }}</span>
      <span class="v-datetime__action v-datetime__confirm" @click="confirm">{{ confirmText }}</span>
    </v-picker>
  </v-popup>
</template>

<script>
  import picker from '@/vuego/components/picker/picker';
  import popup from '@/vuego/components/popup/popup';
